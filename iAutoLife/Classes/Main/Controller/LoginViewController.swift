...
//            self.presentViewController(nav, animated: true, completion: nil)
    ...
    func loginAction(sender:UIButton) {
        ...
        guard userTextField.text != "" && pwTextField.text != "" else {
            self.presentViewController(UIAlertController.alertWith(title: nil, andMessage: "手机号与密码不能为空！"), animated: true, completion: nil)
            return}
        ...
        switch loginType {
        case .DynamicCode:
            let url = XURL_Header + "applogin/message.check"
        ...
        default:
            let url = XURL_Header + "applogin/password"
 ...
 */
    ...
    func getDynamicCode(sender:UIButton) {
        resignFirstResponders()
        let url = XURL_Header + "applogin/message.send?p=\(userTextField.text!)"
