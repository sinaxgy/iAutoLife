...
class FuctionView: UIView {
    ...
    init() {
        ...
        carportButton.setImage(UIImage(named: "parking"), forState: .Normal)
        addSubview(carportButton)
        
        chargeButton.setAttributedTitle(attributedString(" 加油站 附近加油站17个"), forState: UIControlState.Normal)
        chargeButton.setImage(UIImage(named: "fuelling"), forState: .Normal)
    ...
    func attributedString(string:String) -> NSAttributedString {
        ...
        AttributeString.addAttributes([NSFontAttributeName:AlStyle.font.smallest,NSForegroundColorAttributeName:AlStyle.color.gray], range: NSMakeRange(3, AttributeString.length - 3))
        AttributeString.addAttributes([NSFontAttributeName:AlStyle.font.normal,NSForegroundColorAttributeName:UIColor.redColor()], range: NSMakeRange(10, AttributeString.length - 10))
